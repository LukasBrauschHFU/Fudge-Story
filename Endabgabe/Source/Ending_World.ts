namespace Template {
    ...
    export async function Ending_World(): ƒS.SceneReturn {
     // console.log("FudgeStory Template Scene starting");
      ...
      let animation: ƒS.AnimationDefinition = {
        start: {
            translation: ƒS.positionPercent(45, 140)
           // rotation: 1,
          ...
          translation: ƒS.positionPercent(80, 140)
          //  rotation: 1,
          //  scaling: new ƒS.Position(1, 1)
    ...
    //  ƒS.Speech.tell(characters.Narrator, "You decide to meet with Satina in the park");
      ...
      if (dataForSave.Transformation.istransformed == true ) {
        ...
        await ƒS.Character.show(characters.Protagonist, characters.Protagonist.pose.angel, ƒS.positionPercent(45, 140));
        await ƒS.update(2); 
