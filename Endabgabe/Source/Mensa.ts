    ...
    export async function Mensa(): ƒS.SceneReturn {
        ...
        switch (characterDecisionElement) {
          ...
          case characterDecision.Scales:
            ...
            ƒS.Speech.clear();
            await ƒS.update(1);
            if ( dataForSave.MothrinAffection > dataForSave.ScalesAffection || dataForSave.ShubaruAffection > dataForSave.ScalesAffection || dataForSave.SatinaAffection > dataForSave.ScalesAffection ) {
               //Show Mensa
