namespace Template {
    export async function Ending_Evil(): ƒS.SceneReturn {
     ...
     //   await ƒS.Character.show(characters.Protagonist, characters.Protagonist.pose.normal, ƒS.positionPercent(64, 85));
        ...
        await ƒS.Character.show(characters.Mothrin, characters.Mothrin.pose.normal, ƒS.positionPercent(105, 150));
        await ƒS.Character.show(characters.Scales, characters.Scales.pose.normal, ƒS.positionPercent(80, 150));
        ...
        await ƒS.Speech.tell(characters.Scales, "Shut up bitch, you deserve it for stealing my " + dataForSave.Protagonist.name + "!");
