  ...
  //  await ƒS.Speech.tell(characters.Ryu, text.Ryu.T0002),
    ...
    switch (lightDecisionElement2) {
      case lightDecision2.askRude:
          await ƒS.Speech.tell(characters.Mothrin, "I swear, I didn´t want to do anything evil. I just saw the light in your room and wanted to get close to it");
          await ƒS.Speech.tell(characters.Protagonist, "What kind of obsession is this ?"),
          await ƒS.Speech.tell(characters.Mothrin, "For us moths, that is totally normal behavior. We live for the light");
          await ƒS.Speech.tell(characters.Protagonist, "I you say so....Oh well"),
          await ƒS.update(1);
          break;

      case lightDecision2.askFriendly:
       await ƒS.Speech.tell(characters.Mothrin, "Well, I´m studying at the local university. I once saw you getting kicked off the campus for getting too drunk there");
       await ƒS.Speech.tell(characters.Protagonist, "Ah, yeah, I kinda remember seing you there. Weren´t you the girl that drank a whole bottle of *brand censored* Vodka at that campus party and tried to fight a fly girl because she stole one of your pizza slices ?"),
    ...
    switch (lightDecisionElement3) {
      ...
      case lightDecision3.nowork:
       ...
       await ƒS.Speech.tell(characters.Mothrin, "Well, I mean, eh, ff you don´t want to I guess you don´t have too. I was just thinking you might like working at a place with many parties and university students. Also, you could get out of this");
